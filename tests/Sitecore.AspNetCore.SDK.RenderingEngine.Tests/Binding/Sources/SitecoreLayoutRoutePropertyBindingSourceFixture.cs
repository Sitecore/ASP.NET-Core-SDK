...
public class SitecoreLayoutRoutePropertyBindingSourceFixture
{
    ...
    public void GetModel_IsGuarded(
        SitecoreLayoutRoutePropertyBindingSource sut,
        ...
        SitecoreRenderingContext renderingContext)
    {
        // Arrange
        sut.Name = null;
        modelBindingContext.FieldName = "DatabaseName";
        ...
        model.Should().Be("test-database-name");
    }
